...
public enum ValidateCause implements EnumStringCode {
    ...
    NOT_MATCH_FIXED_LEN("005", "'${failFieldChsName}'字段必须为长度${fixedLen}的字符串"),
    NOT_MATCH_PATTERN("006", "'${failFieldChsName}'字段不能匹配表达式'${pattern}'"),
    NOT_MATCH_ENUM("007", "'${failFieldChsName}'字段不能匹配枚举定义"),
    NOT_IMPLEMENT_ENUM_INTERFACE("008", "'${failFieldChsName}'字段的枚举类未实现枚举接口"),
    NOT_SUPPORT_DATA_TYPE("009", "'${failFieldChsName}'字段为不支持的数据类型"),
    NOT_DEFINE_ENUM_FACTORY_METHOD("010", "'${failFieldChsName}'字段枚举类未定义工厂方法");
    String code;
    String desc;
